        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step) => (
            <Card
              ...
              key={step.number}
            >
              <div className="-mr-4 -mt-4 absolute top-0 right-0 font-bold text-8xl text-[#FCBA2E]/10">
                {step.number}
              </div>
              <div className="relative">
                <div className="mb-3 font-bold text-3xl text-[#F9A91C]">
                  {step.number}
                </div>
                <h3 className="mb-3 font-bold text-[#2A190F] text-xl">
                  {step.title}
                </h3>
